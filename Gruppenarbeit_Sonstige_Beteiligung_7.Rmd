...
$\begin{aligned}
\overline{y} &= {\frac {1}{n}}\sum _{i=1}^{n}x_{i} \\
...
mit $s_{note\_p,sk\_p} = -7.08, s_{note\_p} = 0.8366$ und $\overline{y} = 27.2$

$\begin{aligned}
s_{sk\_p} &= \sqrt{ \frac{1}{n-1}\sum_{i=1}^{n}(y_{i}-\overline{y})^2 } \\
&= \sqrt{\frac{(30-27.2)^2+(21-27.2)^2+(12-27.2)^2+(31-27.2)^2+(42-27.2)^2}{4}} \\
&= \sqrt{\frac{2.8^2+-6.2^2+-15.2^2+0.76^2+-11.84^2}{4}} \\
&= \sqrt{\frac{7.84+38.44+231.04+0.5776+140.1856}{4}} \\
&= \sqrt{\frac{418.0832}{4}} \\
&= \sqrt{104.5208} \\
&= 10.22354
\end{aligned}$
